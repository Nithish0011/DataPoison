...
--
-- Host: localhost
-- Generation Time: Jul 06, 2023 at 11:12 AM
...
--
-- Database: `data poising`
--
CREATE DATABASE IF NOT EXISTS `data poising` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `data poising`;
...
('4x34czoofnwu38io0ifsh0a41uugzqgi', 'NzNkNjk2NzA3NWQ3ZWI2MjhiNzg0OWY3ODcxMzM3MTNiZjJkYzVmZjp7InVzZXJpZCI6MX0=', '2023-07-01 08:09:47.052878'),
...
(1, 'Abhinay', 'abhinay0703@gmail.com', '123456', '9874563210', 'India', 'Telangana', 'Hyderabad', 'Hyderabad', 'Male');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_ddos_attacks_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_ddos_attacks_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `RID` varchar(3000) NOT NULL,
  `Protocol` varchar(3000) NOT NULL,
  `ip_src` varchar(3000) NOT NULL,
  `ip_dst` varchar(3000) NOT NULL,
  `pro_srcport` varchar(3000) NOT NULL,
  `pro_dstport` varchar(3000) NOT NULL,
  `flags_ack` varchar(3000) NOT NULL,
  `ip_flags_mf` varchar(3000) NOT NULL,
  `ip_flags_df` varchar(3000) NOT NULL,
  `ip_flags_rb` varchar(3000) NOT NULL,
  `pro_seq` varchar(3000) NOT NULL,
  `pro_ack` varchar(3000) NOT NULL,
  `frame_time` varchar(3000) NOT NULL,
  `Packets` varchar(3000) NOT NULL,
  `Bytes1` varchar(3000) NOT NULL,
  `Tx_Packets` varchar(3000) NOT NULL,
  `Tx_Bytes` varchar(3000) NOT NULL,
  `Rx_Packets` varchar(3000) NOT NULL,
  `Rx_Bytes` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_ddos_attacks_prediction`
--

INSERT INTO `remote_user_ddos_attacks_prediction` (`id`, `RID`, `Protocol`, `ip_src`, `ip_dst`, `pro_srcport`, `pro_dstport`, `flags_ack`, `ip_flags_mf`, `ip_flags_df`, `ip_flags_rb`, `pro_seq`, `pro_ack`, `frame_time`, `Packets`, `Bytes1`, `Tx_Packets`, `Tx_Bytes`, `Rx_Packets`, `Rx_Bytes`, `Prediction`) VALUES
(1, 'C154988899', 'udp', '192.168.1.1', '192.168.23.2', '2418', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.071174000 Mountain Daylight Time', '8', '432', '4', '216', '4', '216', 'smurf'),
(2, 'C1912850431', 'udp', '192.168.1.1', '192.168.23.2', '2419', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.071180000 Mountain Daylight Time', '12', '648', '6', '324', '6', '324', 'smurf'),
(3, 'C1026483832', 'tcp', '192.168.1.1', '192.168.23.2', '2426', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.071363000 Mountain Daylight Time', '10', '540', '5', '270', '5', '270', 'smurf'),
(4, 'C1574873161', 'udp', '192.168.1.1', '192.168.23.2', '2667', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.082221000 Mountain Daylight Time', '4', '216', '2', '108', '2', '108', 'Normal'),
(5, 'C973936431', 'tcp', '192.168.1.1', '192.168.23.2', '2686', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.082490000 Mountain Daylight Time', '12', '648', '6', '324', '6', '324', 'Fraggile'),
(6, 'C1751500625', 'icmp', '192.168.1.1', '192.168.23.2', '3299', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.094226000 Mountain Daylight Time', '12', '648', '6', '324', '6', '324', 'Fraggile'),
(7, 'C1231006815', 'udp', '192.168.1.1', '192.168.23.2', '2412', '8000', '1', '0', '0', '0', '1', '1', ' 16-Jun 2020 20:18:15.071112000 Mountain Daylight Time', '8', '432', '4', '216', '4', '216', 'smurf');
...
(44, 'Naive Bayes', '47.2840790842872'),
(45, 'SVM', '47.2840790842872'),
(46, 'Logistic Regression', '47.2840790842872'),
(47, 'Random Forest Classifier', '47.2840790842872');
...
(29, 'normal', '16.666666666666664'),
(30, 'Fraggile', '33.33333333333333'),
(31, 'smurf', '50.0');
